...
######################1200 clones####################
rm(list=ls())
setwd("C:/Users/uqsyada1/OneDrive - The University of Queensland/PhD/Research Chapter-Allele dosages/Data/Output/15Plates_data/total_batch_file/Analysis_Review/Final_Analysis/Folder1/BayesR_Scenario1/dip_26k")
library(data.table)
...
cor(testpop$TCHBlup, testpop$tch_GEBV) ## 0.5324415
...
cor(testpop$CCSBlup, testpop$ccs_GEBV) ## 0.2787178
#######################################################
####################### Fibre ##########################
