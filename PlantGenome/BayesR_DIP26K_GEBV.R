...
######################1200 clones####################
rm(list=ls())
setwd("C:/Users/uqsyada1/OneDrive - The University of Queensland/PhD/Research Chapter-Allele dosages/Data/Output/15Plates_data/total_batch_file/Analysis_Review/Final_Analysis/Folder1/BayesR_Scenario2/dip_26k")
library(data.table)
...
cor(testpop$TCHBlup, testpop$tch_GEBV) ## 0.4992201
...
cor(testpop$CCSBlup, testpop$ccs_GEBV) ## 0.3269472
#######################################################
####################### Fibre ##########################
...
dim(fibre_Effects)
fibre_Effects[1:5,]
fibre_Effects<- fibre_Effects[-23463,]
fibre_Effects <- as.matrix(fibre_Effects)
dim(fibre_Effects)
...
cor(testpop$FibreBlup, testpop$fibre_GEBV) ## 0.5600437
###############################################################
####################MSE ##################################
############ MSE #########################################
