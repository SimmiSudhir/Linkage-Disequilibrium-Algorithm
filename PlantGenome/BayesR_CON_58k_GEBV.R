...
row.names(M_1318_total) <- M_1318_total$Clone
M_1318_total <- M_1318_total[-1]
M_771 <- M_1318_total[row.names(M_1318_total) %in% new_df$id,]
dim(M_771) ## 771 25753
M_771[1:5,1:5]
...
cor(testpop$TCHBlup, testpop$tch_GEBV) ## 0.5224347
...
cor(testpop$CCSBlup, testpop$ccs_GEBV) ## 0.2331266
#######################################################
####################### Fibre ##########################
...
cor(testpop$FibreBlup, testpop$fibre_GEBV) ## 0.5813511
###############################################################
####################MSE ##################################
############ MSE #########################################
