...
Marker_dip_771 <- new_M_771

dim(Marker_dip_771) ## 1200 25753

Marker_dip_771 <- as.matrix(Marker_dip_771)
Marker_dip_771 <- t(Marker_dip_771)
dim(Marker_dip_771)
Marker_dip_771[1:5,1:5]

fwrite(Marker_dip_771,"scenario2.gt.cgen",row.names=F, col.names=F,sep=" ")
